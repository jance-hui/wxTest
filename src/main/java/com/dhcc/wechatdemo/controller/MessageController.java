    ...
    public String getAndSendMsg(HttpServletRequest request){
        ...
        if ("text".equals(msgType)){
            ...
            if ("图片".equals(content)){
                ...
                // 个人订阅号
                messageStr = messageService.backImageMsg(fromUserName, toUserName,"MpFQFD6QjLRbUIh8nT_e_hm8xp48bsNBB09Kb9mg6HU" );
                ...
                // 个人订阅号
                messageStr = messageService.backVoiceMsg(fromUserName, toUserName,"MpFQFD6QjLRbUIh8nT_e_haeWH1Q5LlOQa7LUTT0asE" );
                ...
                // 个人订阅号
                messageStr = messageService.backVideoMsg(fromUserName, toUserName,"MpFQFD6QjLRbUIh8nT_e_sUQR7ZSeBoqfXxlrhGO4_Y",
                        "测试上传视频","这是我上传的第一个视频" );
            }else if ("图文".equals(content)){
                Article article1 = new Article();
                article1.setTitle("测试标题了");
                article1.setDescription("测测测312312测测测正文");
                article1.setPicUrl("http://mmbiz.qpic.cn/mmbiz_jpg/ZGIlDYnS0hKibncgUr5IcY5kyxcsxUBqTicvEichoD9oOxbbbegR1MuFhhzB0Jiabtj46An1WIgramppRv7FhHCe6Q/0?wx_fmt=jpeg");
                article1.setUrl("http://mp.weixin.qq.com/s?__biz=MzIyNzg4MjY0MA==&mid=100000012&idx=1&sn=2201976c8954b0759dcdf9257df3874a&chksm=685b22f35f2cabe5f7881864acedb2eb51b08213cc0516336e8063580281c9390b0e1f2097fa#rd");
                Article article2 = new Article();
                article2.setTitle("测试3");
                article2.setDescription("测测3");
                article2.setPicUrl("http://mmbiz.qpic.cn/mmbiz_jpg/ZGIlDYnS0hKibncgUr5IcY5kyxcsxUBqTicvEichoD9oOxbbbegR1MuFhhzB0Jiabtj46An1WIgramppRv7FhHCe6Q/0?wx_fmt=jpeg");
                article2.setUrl("http://mp.weixin.qq.com/s?__biz=MzIyNzg4MjY0MA==&mid=100000012&idx=3&sn=89ca7dfaf02f32f0999ec6c25c50f8ff&chksm=685b22f35f2cabe5c805ac071a7cf6a8f24c316217e94dfc7f138e76913820c4f57344bdb0df#rd");

                List<Article> item = new ArrayList<>();
                item.add(article1);
                item.add(article2);

                messageStr = messageService.backArticleMsg(fromUserName, toUserName, item, 1);
            }else {
            ...
            if ("图片".equals(eventKey)){
                ...
                messageStr = messageService.backArticleMsg(fromUserName, toUserName, item, 2);
            }
        }else{
            Article article1 = new Article();
            article1.setTitle("测试标题了");
